# Autogenerated wrapper script for openbabel_jll for aarch64-apple-darwin
...
JLLWrappers.@declare_library_product(libinchi, "@rpath/libinchi.0.dylib")
JLLWrappers.@declare_library_product(libopenbabel, "@rpath/libopenbabel.7.dylib")
...
function __init__()
    ...
    JLLWrappers.@init_library_product(
        libinchi,
        "lib/libinchi.0.4.1.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libopenbabel,
        "lib/libopenbabel.7.0.0.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )
